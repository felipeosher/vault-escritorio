...
2. **A área não valia nada antes de ser regularizada.** Só passou a ter valor depois do trabalho de regularização concluído por Felipe.
3. **Logo após a regularização**, apareceu um **advogado da mulher que vendeu a área para o Paulo**, alegando **fraude**.
4. Esse advogado é, segundo Felipe, um **falsificador**. A leitura de Felipe: é uma **tentativa de golpe** — querem se apropriar do valor criado pela regularização, atacando justamente depois que a área valorizou.

## Tese / linha de trabalho
- Defender a 3V Holding / Paulo: a alegação de fraude é oportunista, surge só após a valorização decorrente da regularização.
