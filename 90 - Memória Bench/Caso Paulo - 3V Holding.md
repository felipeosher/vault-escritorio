---
tipo: memoria
tema: caso Paulo / 3V Holding
gatilho: "processo do Paulo"
criado: 2026-06-21
---

# Caso Paulo — 3V Holding

> **Gatilho de memória:** quando o Felipe falar "processo do Paulo", é ESTE caso.

## Quem é
- **Paulo** = dono da **3V Holding Participações Ltda** (CNPJ 37.578.132/0001-05).
- Cliente do escritório.

## O que aconteceu (linha do tempo)
1. Felipe fez a **regularização fundiária** da área do Paulo (Tarumã, Manaus) via **usucapião extrajudicial** — Processo **0090145-53.2025.8.04.1000**, Vara de Registros Públicos de Manaus. Resultado favorável: dúvida registral julgada **improcedente** (sentença 09/02/2026, Juiz Cid da Veiga Soares Jr.), transitada em julgado, arquivada 15/04/2026. Caminho liberado pro registro da área particular.
...
- Os dois processos + o Memorial + a PEÇA DO AGRAVO já redigida estão no vault, com análise. Estrutura navegável montada (HUB + linha do tempo + prazos + estratégia + Memorial + peça pronta + fichas de pessoas).
- **A peça do Agravo de Instrumento já está ESCRITA e assinada** por Felipe Benchaya (OAB/AM 19.500) e Thaís Cohen Chalub (OAB/AM 14.501) — docx no vault: `Agravo de Instrumento - 3V Holding e Paulo (peça para protocolo).docx`. Ver [[Caso Paulo - Agravo de Instrumento (peça pronta)]].
- **Movimento mais urgente:** PROTOCOLAR o agravo (prazo 15 dias da intimação da decisão de 18/06). A peça já contempla a tese de que os agravantes ainda NÃO foram citados (ciência por meio diverso). Antes de protocolar: preencher os campos `[•]` (data de ciência, data, guia de preparo) e juntar peças obrigatórias do art. 1.017 (decisão agravada, inicial+docs, procuração).
...
## Conexões
- [[_Caso Paulo - HUB]] ← **porta de entrada do caso** (começar por aqui)
- [[Paulo]]
- [[Resumo - Processo 0090145-53.2025.8.04.1000]] (regularização — favorável)
- [[Resumo - Processo 0150438-52.2026.8.04.1000 (Acao de Fraude)]] (ação de nulidade — defesa)
- [[Caso Paulo - Tentativa de fraude pós-regularização]]
- [[Caso Paulo - Linha do tempo]]
- [[Caso Paulo - Prazos e próximos passos]]
- [[Caso Paulo - Estratégia de defesa]]
- [[Marilene Coelho Fontinelli]] · [[Daniel Rocha Nóbrega]] · [[Leandro Rebelo de Paula]]
